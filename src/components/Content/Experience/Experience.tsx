...
import { Timeline, Text, Card, Group, Image, Flex, Badge, Accordion, List } from "@mantine/core";
...
export default function ExperienceScrollWithDots() {
    ...
    return (
        <>
            ...
            <Timeline active={0} lineWidth={6} my="lg">
                    ...
                    <Timeline.Item key={index + 1}>
                        <Card shadow="md" radius="md" withBorder w={{ md: "600px" }}>
                            ...
                            <Card.Section px={"md"}>
                                ...
                                <Text c="dimmed" className={classes.period}>{item.period}</Text>
                            </Card.Section>
                            <Card.Section p={"md"}>
                                <Group gap="xs">
                                    {item.techStack.map((tech, index) => (
                                        <Badge key={index + 1} variant="light" color="blue">{tech}</Badge>
                                    ))}
                                </Group>
                            </Card.Section>
